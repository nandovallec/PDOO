  ...
  class Qytetet
    ...
    def intentar_salir_carcel(metodo)
      ...
      if metodo == MetodoSalirCarcel::TIRANDODADO
        ...
        tengo_saldo = @jugadorActual.pagarLibertad(@@PRECIO_LIBERTAD)
        libre = tengo_saldo
      end
    ...
    def jugar()
      valor_dado = @dado.tirar()
      print("Te ha salido un #{valor_dado}\n")
    ...
    def obtener_ranking()
      ...
      for jugador in @jugadores
        ...
        ranking << Pair.new(jugador.nombre, capital)
      end
