            ...
            if bancarrota
              ...
              if @jugador.encarcelado
                ...
                if @casilla.tipo == TipoCasilla::CALLE
                  ...
                  if @vista.elegir_quiero_comprar == 1 and not @casilla.tengo_propietario
                  ...
                  if (not @jugador.encarcelado and not bancarrota and not @casilla.tengo_propietario and
                    @casilla.tipo == TipoCasilla::CALLE and @vista.elegir_quiero_comprar)
